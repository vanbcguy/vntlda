...
unsigned char boostDCMax1[] = {
  ...
  170,180,188,200,  255,255,
  170,180,190,225,  255,255,
  170,195,225,225,  255,255,
  170,215,225,245,  255,255,
  170,225,235,255,  255,255,
  160,225,235,255,  255,255,  
  00,00,00,                  // lastX,lastY,lastRet
};
...
const prog_uchar versionString[] PROGMEM  = "DMN Boost Ctrl v2.0f."; 
